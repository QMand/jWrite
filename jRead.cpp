...
//		float	jRead_float( char *pJson, char *pQuery );
...
const char *	jRead_atof( const char *p, float *result);
...
const char * jReadCountArray( const char *pJson, struct jReadElement *pResult )
{
	...
	}else
	{
		while( 1 )
		{
			pJson= jRead( ++pJson, emptyString, &jElement );	// array value
			if( pResult->error )
				break;
...
const char *jReadArrayStep( const char *pJsonArray, struct jReadElement *pResult )
{
	...
	case JREAD_COMMA:	// element separator
		return jRead( ++pJsonArray, emptyString, pResult );
...
//
float jRead_float( const char *pJson, const char *pQuery, int *queryParams )
{
	struct jReadElement elem;
	float result;
	jReadParam( pJson, pQuery, &elem, queryParams );
...
// Optional String output Functions
//
#ifdef INCL_jReadTypeToString

const char jReadType_0[] PROGMEM =	"Error";			// 0
const char jReadType_1[] PROGMEM =	"Object";			// 1
const char jReadType_2[] PROGMEM =	"Array";			// 2
const char jReadType_3[] PROGMEM =	"String";			// 3
const char jReadType_4[] PROGMEM =	"Number";			// 4
const char jReadType_5[] PROGMEM =	"Bool";				// 5
const char jReadType_6[] PROGMEM =	"null";				// 6
const char jReadType_7[] PROGMEM =	"Object key";	// 7
const char jReadType_8[] PROGMEM =	"colon";			// 8
const char jReadType_9[] PROGMEM =	"eol";				// 9
const char jReadType_10[] PROGMEM =	"comma";			// 10
const char jReadType_11[] PROGMEM =	"}";				  // 11
const char jReadType_12[] PROGMEM =	"]";				  // 12
const char jReadType_13[] PROGMEM =	"* parameter";// 13

const char * const jReadTypeStrings[14] PROGMEM ={
  jReadType_0, jReadType_1, jReadType_2, jReadType_3, jReadType_4,
  jReadType_5, jReadType_6, jReadType_7, jReadType_8, jReadType_9,
  jReadType_10, jReadType_11, jReadType_12, jReadType_13
};

// jReadTypeMessage
// - copies a message describing data type into destBuffer
// - returns pointer to buffer
//
char * jReadTypeMessage( char *destBuffer, int destLength, int datatype )
{
  if( (datatype < 0 ) || (datatype > 13) )
    datatype= 0;
  char *sp= (char *)pgm_read_word(&(jReadTypeStrings[datatype]));  
  strncpy_P( destBuffer, sp, destLength );
  return destBuffer;
};
#endif /* INCL_jReadTypeToString */

#ifdef INCL_jReadErrorToString
const char jReadError_0[] PROGMEM = 	"Ok";                                       // 0
const char jReadError_1[] PROGMEM = 	"JSON does not match Query";                // 1
const char jReadError_2[] PROGMEM = 	"Error reading JSON value";                 // 2
const char jReadError_3[] PROGMEM = 	"Expected \"key\"";                         // 3
const char jReadError_4[] PROGMEM = 	"Expected ':'";                             // 4
const char jReadError_5[] PROGMEM = 	"Object key not found";                     // 5
const char jReadError_6[] PROGMEM = 	"Expected ',' in object";                   // 6
const char jReadError_7[] PROGMEM = 	"Terminal value found before end of query"; // 7
const char jReadError_8[] PROGMEM = 	"Unexpected character";                     // 8
const char jReadError_9[] PROGMEM = 	"Expected ',' in array";                    // 9
const char jReadError_10[] PROGMEM = 	"Array element not found (bad index)";      // 10
const char jReadError_11[] PROGMEM = 	"Object key not found (bad index)";	    		// 11
const char jReadError_12[] PROGMEM = 	"Bad object key";							              // 12
const char jReadError_13[] PROGMEM = 	"End of array found";						            // 13
const char jReadError_14[] PROGMEM = 	"End of object found";						          // 14
const char jReadError_15[] PROGMEM =  "Unknown error";                            // 15

const char * const jReadErrorStrings[15] PROGMEM = {
  jReadError_0, jReadError_1, jReadError_2, jReadError_3, jReadError_4,
  jReadError_5, jReadError_6, jReadError_7, jReadError_8, jReadError_9,
  jReadError_10, jReadError_11, jReadError_12, jReadError_13, jReadError_14 };

// jReadErrorMessage
// - copies a message describing error into destBuffer
// - returns pointer to buffer
//
char * jReadErrorMessage( char *destBuffer, int destLength, int error )
{
  if( (error < 0 ) || (error > 14) )
    error= 15;
  char *sp= (char *)pgm_read_word(&(jReadErrorStrings[error]));  
  strncpy_P( destBuffer, sp, destLength );
  return destBuffer;
};
#endif /*  INCL_jReadErrorToString */
